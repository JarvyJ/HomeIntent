...
class BaseShoppingList:
    ...
    def _add_item_to_shopping_list(self, shopping_list_item):
        self.ha.api.call_service("shopping_list", "add_item", {"name": shopping_list_item})

    def _mark_item_complete_on_shopping_list(self, shopping_list_item):
        self.ha.api.call_service("shopping_list", "complete_item", {"name": shopping_list_item})

    def _unmark_item_complete_on_shopping_list(self, shopping_list_item):
        self.ha.api.call_service("shopping_list", "incomplete_item", {"name": shopping_list_item})
