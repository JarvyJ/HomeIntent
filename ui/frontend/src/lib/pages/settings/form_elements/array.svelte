...
<div class="col-start-1">
  ...
  <HelpText classes="mt-3">
    Example:
    <code class="block p-2 bg-gray-700 text-gray-50 rounded-md">
      <pre>
{example.join("\n")}
    </pre
      >
...
<textarea
  ...
  class="text-area border border-gray-300 bg-gray-800 border-gray-500 rounded-md focus:outline-none p-1.5"
  rows="5"
  cols="40"
