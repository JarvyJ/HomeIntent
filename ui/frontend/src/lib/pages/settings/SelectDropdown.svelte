...
<script>
  ...
  const id_name = name.replace(" ", "").toLowerCase()
...
<select id="{id_name}" bind:value={selectedValue} class="border chevron-down p-1.5 pr-8 border-gray-300 rounded-md appearance-none">
